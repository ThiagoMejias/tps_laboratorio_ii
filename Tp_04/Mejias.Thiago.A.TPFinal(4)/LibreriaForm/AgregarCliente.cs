        ...
        private void btn_Agregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (bacos.clientes.add(new Cliente(dateTime_cliente.Value, this.txt_nombre.Text, int.Parse(this.txt_Dni.Text), this.txt_direccion.Text, 0)))
                {
                    ...
                    ClienteDao.Guardar(bacos.buscarCliente(int.Parse(this.txt_Dni.Text)));
            ...
            {
                MessageBox.Show(ex.Message, "Error Guardar datos", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
